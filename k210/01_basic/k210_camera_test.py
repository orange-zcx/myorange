...
lcd.rotation(2)                    # Rotate the hardware LCD by 180 degrees.
...
sensor.set_hmirror(1)               # Correct left-right orientation.
sensor.set_vflip(1)                 # Correct top-bottom orientation.
