...
# External green TX wire is mapped to K210 GPIO7.
...
while True:
    ...
    if candidate:
        ...
        # A card must be removed before the next digit can be sent.
        if miss_frames >= 12 and not send_armed:
            send_armed = True
            print("UART READY FOR NEXT DIGIT")
